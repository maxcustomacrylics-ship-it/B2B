    ...
    <section className="relative bg-white overflow-hidden">
      <Container className="py-16 lg:py-24">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          <div>
            <span className="inline-block rounded-full bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-700 tracking-wide mb-4">OEM & ODM Acrylic Manufacturer</span>
            <h1 className="text-4xl font-bold tracking-tight text-[#0F2744] sm:text-5xl lg:text-6xl leading-tight">Custom Acrylic Products Manufacturer in China</h1>
            <p className="mt-5 text-lg text-gray-500 leading-relaxed max-w-xl">OEM & ODM acrylic fabrication services for global businesses. From custom displays to retail fixtures and promotional products — high-quality manufacturing with flexible MOQ and fast turnaround.</p>
