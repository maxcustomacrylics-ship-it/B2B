...
const categories = [
  { title: "Acrylic Displays", href: "/products/acrylic-displays", count: "8 products", emoji: "🖼", desc: "Retail stands, cosmetic displays, brochure holders, counter displays and more." },
  { title: "Acrylic Boxes", href: "/products/acrylic-boxes", count: "6 products", emoji: "📦", desc: "Storage boxes, donation boxes, ballot boxes, display cases, lock boxes." },
  { title: "Acrylic Signage", href: "/products/acrylic-signage", count: "6 products", emoji: "📋", desc: "Office signs, door signs, name plates, QR code stands, wall signs." },
  { title: "Acrylic Home & Office", href: "/products/acrylic-home-office", count: "6 products", emoji: "🏠", desc: "Desk organizers, monitor stands, makeup organizers, trays, book stands." },
];
