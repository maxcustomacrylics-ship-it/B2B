...
export const servicePages: ServicePageData[] = [
  {
    slug: "laser-cutting", title: "Laser Cutting", h1: "Precision Acrylic Laser Cutting Services",
    metaDesc: "High-precision CO2 laser cutting for acrylic sheets — ±0.1mm tolerance, flame-polished edges, fast turnaround. Ideal for signage, displays, and custom parts.",
    intro: "Our laser cutting service delivers exceptional precision for custom acrylic components. Using industrial CO2 laser systems, we achieve clean cuts with flame-polished edges and tolerances as tight as ±0.1mm. From intricate signage to complex display components, laser cutting provides the accuracy and edge quality your project demands.",
