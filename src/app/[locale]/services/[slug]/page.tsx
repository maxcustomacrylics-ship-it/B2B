    ...
    <>
      ...
      <Container className="py-12">
        ...
        <div className="mt-8 grid gap-10 lg:grid-cols-2 items-center">
          <div>
            <h1 className="text-3xl font-bold text-[#0F2744] sm:text-4xl">{s.h1}</h1>
            <p className="mt-4 text-gray-500 leading-relaxed">{s.intro}</p>
            <div className="mt-6 flex gap-3"><Link href="/contact" className="inline-flex items-center gap-2 rounded-lg bg-[#0F2744] px-5 py-3 text-sm font-semibold text-white hover:bg-[#1a3a5c]">Request Quote <ArrowRight className="h-4 w-4" /></Link></div>
          </div>
