          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center min-h-[520px] lg:min-h-[560px]">
            ...
            <div className="relative" aria-hidden="true">
              <div className="grid grid-cols-3 gap-2">
                {[
                  { icon: "💎", label: "Luxury", color: "from-blue-100 to-blue-50/60" },
                  { icon: "🏆", label: "Awards", color: "from-amber-100 to-amber-50/60" },
                  { icon: "👁", label: "Crystal", color: "from-sky-100 to-sky-50/60" },
                  { icon: "🛍", label: "Premium", color: "from-emerald-100 to-emerald-50/60" },
                  { icon: "🏛", label: "Museum", color: "from-purple-100 to-purple-50/60" },
                  { icon: "✨", label: "Optical", color: "from-rose-100 to-rose-50/60" },
                ].map((img, i) => (
              ...
              <span className="sr-only">Diamond polishing for luxury displays, awards, crystal-clear edges, premium retail, museum vitrines and optical-grade clarity</span>
            </div>
          </div>
        </Container>
      </section>
